...
.method private createTranslationAnimation(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    .line 275
    .local v15, "motionTiming":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/android/material/animation/MotionTiming;Lcom/google/android/material/animation/MotionTiming;>;"
    ...
    .local v2, "translationYAnimator":Landroid/animation/ValueAnimator;
    :goto_0
...
.method protected onCreateExpandedStateChangeAnimation(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .local p1, "isAnimating":Z
    .local p2, "childBounds":Landroid/graphics/RectF;
    invoke-virtual {p2}, Landroid/graphics/RectF;->width()F

    move-result p3

    .line 148
    .local p3, "childWidth":F
    invoke-virtual {p2}, Landroid/graphics/RectF;->height()F

    move-result p4

    .line 150
    .local p4, "childHeight":F
    move-object v1, p0
    ...
    .end local v7    # "animations":Ljava/util/List;, "Ljava/util/List<Landroid/animation/Animator;>;"
    ...
    .end local v5    # "spec":Lcom/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec;
    .local v6, "spec":Lcom/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec;
    .restart local v7    # "animations":Ljava/util/List;, "Ljava/util/List<Landroid/animation/Animator;>;"
    move v5, p1

    .end local p1    # "isAnimating":Z
    .local v5, "isAnimating":Z
    ...
    .end local p3    # "childWidth":F
    .end local p4    # "childHeight":F
