...
.method public static final getFormatColorText(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 30
    .local v3, "$i$a$-materialIcon$default-FormatColorTextKt$FormatColorText$1":I
    move-object v4, v1
    ...
    .local v24, "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v31, 0x0

    .line 31
    .local v31, "$i$a$-materialPath-YwgOQQI$default-FormatColorTextKt$FormatColorText$1$1":I
    move/from16 v32, v6
    ...
    .end local v24    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v9, "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v9    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v24    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 34
    .end local v24    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v9    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v6, v0, v0, v0}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    invoke-virtual {v9, v0, v6, v6, v6}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveTo(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 104
    .end local v9    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v31    # "$i$a$-materialPath-YwgOQQI$default-FormatColorTextKt$FormatColorText$1$1":I
    nop
    ...
    .local v9, "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0
    ...
    .local v31, "$this$_get_FormatColorText__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    ...
    .end local v9    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v23, "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    invoke-virtual/range {v23 .. v29}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveToRelative(FFFFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;

    .line 44
    move-object/from16 v0, v23

    .end local v23    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v0, "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v0    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v23    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .line 49
    .end local v23    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .restart local v0    # "$this$_get_FormatColorText__u24lambda_u242_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v24, 0x4156e148    # 13.43f

    const v25, 0x405e147b    # 3.47f

    const/high16 v26, 0x414c0000    # 12.75f
    ...
    .end local v3    # "$i$a$-materialIcon$default-FormatColorTextKt$FormatColorText$1":I
    .local v33, "$i$a$-materialIcon$default-FormatColorTextKt$FormatColorText$1":I
    const v3, 0x3ef0a3d7    # 0.47f

    invoke-virtual {v0, v2, v3, v1, v9}, Landroidx/compose/ui/graphics/vector/PathBuilder;->reflectiveCurveToRelative(FFFF)Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    const v25, 0x4181ae14    # 16.21f

    const v26, 0x40ca8f5c    # 6.33f
    ...
    .line 79
    .end local v31    # "$this$_get_FormatColorText__u24lambda_u242":Landroidx/compose/ui/graphics/vector/ImageVector$Builder;
    .end local v33    # "$i$a$-materialIcon$default-FormatColorTextKt$FormatColorText$1":I
