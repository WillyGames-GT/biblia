...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v7}, Landroidx/compose/ui/platform/ViewConfiguration;->getTouchSlop()F
    ...
    iput-object v6, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->L$0:Ljava/lang/Object;

    iput v5, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->F$0:F

    iput v12, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->F$1:F

    iput-wide v13, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->J$0:J

    iput v15, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->I$0:I

    iput v7, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->F$2:F

    iput v8, v2, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->I$1:I
    ...
    .end local v11    # "lockedToPanZoom":Z
    ...
    iget-boolean v3, v15, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->$panZoomLock:Z

    if-eqz v3, :cond_5

    cmpg-float v3, v19, v7
    ...
    .restart local v6    # "lockedToPanZoom":Z
    goto :goto_6
    ...
    .restart local v18    # "zoomChange":F
    :cond_7
    :goto_6
    if-eqz v8, :cond_10
    ...
    invoke-static {v4, v3}, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt;->calculateCentroid(Landroidx/compose/ui/input/pointer/PointerEvent;Z)J
    ...
    .local v21, "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    ...
    .line 91
    .end local v21    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    .restart local v4    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    :cond_b
    move-object/from16 v21, v4

    .end local v4    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    .restart local v21    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    goto :goto_9
    ...
    .restart local v21    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    :goto_9
    iget-object v3, v15, Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;->$onGesture:Lkotlin/jvm/functions/Function4;
    ...
    :cond_d
    invoke-virtual/range {v21 .. v21}, Landroidx/compose/ui/input/pointer/PointerEvent;->getChanges()Ljava/util/List;
    ...
    .end local v2    # "this":Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;
    .end local v4    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    .restart local v15    # "this":Landroidx/compose/foundation/gestures/TransformGestureDetectorKt$detectTransformGestures$2;
    .restart local v17    # "canceled":Z
    .restart local v21    # "event":Landroidx/compose/ui/input/pointer/PointerEvent;
    :goto_b
    if-nez v17, :cond_15
