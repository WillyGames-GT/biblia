...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    ...
    .line 222
    .end local v0    # "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    ...
    .line 223
    .local v1, "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$this_invalidationTrackerFlow:Landroidx/room/RoomDatabase;

    invoke-virtual {v2}, Landroidx/room/RoomDatabase;->getInvalidationTracker()Landroidx/room/InvalidationTracker;

    move-result-object v2

    iget-object v3, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$observer:Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$observer$1;
    ...
    .line 225
    :try_start_1
    iget-boolean v2, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$emitInitialState:Z

    if-eqz v2, :cond_0

    .line 227
    iget-object v2, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$$this$callbackFlow:Lkotlinx/coroutines/channels/ProducerScope;

    iget-object v3, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$tables:[Ljava/lang/String;
    ...
    .line 229
    :cond_0
    iget-object v2, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$ignoreInvalidation:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v3, v1, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->label:I
    ...
    .end local v1    # "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    .restart local v0    # "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    :goto_0
    :try_start_2
    ...
    .line 232
    .restart local v1    # "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    :catchall_1
    move-exception v0
    ...
    .restart local v0    # "this":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    :goto_1
    iget-object v2, v0, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$this_invalidationTrackerFlow:Landroidx/room/RoomDatabase;

    invoke-virtual {v2}, Landroidx/room/RoomDatabase;->getInvalidationTracker()Landroidx/room/InvalidationTracker;

    move-result-object v2

    iget-object v3, v0, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;->$observer:Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$observer$1;
