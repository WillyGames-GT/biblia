...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 211
    .local v9, "$this$callbackFlow":Lkotlinx/coroutines/channels/ProducerScope;
    new-instance v11, Ljava/util/concurrent/atomic/AtomicBoolean;

    iget-boolean v4, v2, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1;->$emitInitialState:Z

    invoke-direct {v11, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    .line 212
    .local v11, "ignoreInvalidation":Ljava/util/concurrent/atomic/AtomicBoolean;
    new-instance v7, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$observer$1;

    iget-object v4, v2, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1;->$tables:[Ljava/lang/String;

    invoke-direct {v7, v4, v11, v9}, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$observer$1;-><init>([Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;Lkotlinx/coroutines/channels/ProducerScope;)V

    .line 221
    .local v7, "observer":Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$observer$1;
    invoke-interface {v9}, Lkotlinx/coroutines/channels/ProducerScope;->getCoroutineContext()Lkotlin/coroutines/CoroutineContext;
    ...
    :cond_0
    iget-object v4, v2, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1;->$this_invalidationTrackerFlow:Landroidx/room/RoomDatabase;
    ...
    .line 222
    .local v4, "queryContext":Lkotlin/coroutines/ContinuationInterceptor;
    move-object v13, v9
    ...
    new-instance v5, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1$job$1;
    ...
    .end local v11    # "ignoreInvalidation":Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v7, v2, Landroidx/room/RoomDatabaseKt$invalidationTrackerFlow$1;->label:I

    invoke-static {v9, v5, v6}, Lkotlinx/coroutines/channels/ProduceKt;->awaitClose(Lkotlinx/coroutines/channels/ProducerScope;Lkotlin/jvm/functions/Function0;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v4

    .end local v4    # "job":Lkotlinx/coroutines/Job;
    .end local v9    # "$this$callbackFlow":Lkotlinx/coroutines/channels/ProducerScope;
    if-ne v4, v0, :cond_2
