...
.method private final copyDatabaseFile(Ljava/io/File;Z)V
    ...
    const-string/jumbo v2, "newChannel(context.assets.open(copyFromAssetPath))"
    ...
    const-string/jumbo v3, "newChannel(inputStream)"
    ...
    :cond_3
    :goto_1
    const-string/jumbo v4, "intermediateFile"
    ...
    const-string/jumbo v3, "inputStreamCallable exception on call"
